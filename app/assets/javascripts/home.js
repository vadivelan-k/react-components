...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsTimer = __webpack_require__(158);

	var _componentsTimer2 = _interopRequireDefault(_componentsTimer);

	console.log('home js');

	console.log('timer: ', _componentsTimer2['default']);

	Window.Home = {
	  init: function init() {
	    _react2['default'].render(_react2['default'].createElement(_componentsTimer2['default'], { time: new Date() }), document.getElementById("react-components"));
	  }
	};
